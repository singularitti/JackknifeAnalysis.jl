...
\begin{figure}
    ...
    \begin{minipage}[t]{0.8\linewidth}
        ...
        \subcaption{The standard deviation \(\sigma^2_{f_1,N}\) of these \(N/b\) groups as a
        function of sizes of bins \(b\).}
    ...
    \begin{minipage}[t]{0.8\linewidth}
        ...
        \subcaption{The standard deviation \(\sigma^2_{f_2,N}\) of these \(N/b\) groups as a
        function of sizes of bins \(b\).}
