...
the autocorrelation functions start to become unstable. We pick the \(n_\textnormal{cut}\)
where the autocorrelation functions immediately become negative as our cut-off \(n\).
